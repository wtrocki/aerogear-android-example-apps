...
package org.aerogear.android.app.memeolist.sync.objects;
...
public interface AppSyncQueryWatcher<T> extends Cancelable {
  ...
  AppSyncQueryWatcher<T> enqueueAndWatch(@Nullable final ApolloCall.Callback<T> callback);
  ...
  /**
   * Cancels this {@link AppSyncQueryWatcher}. The {@link ApolloCall.Callback}
