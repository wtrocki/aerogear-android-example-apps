...
import org.aerogear.android.app.memeolist.sync.mutation.PersistentOfflineMutationObject;
...
public final class AppSyncMutationSqlCacheOperations {
    ...
    public AppSyncMutationSqlCacheOperations(SQLiteOpenHelper dbHelper) {
